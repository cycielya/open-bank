...
public class AccountPO extends PatternObject<AccountPO, Account>
{
   ...
   public TransactionPO createTransactionPO()
   {
      ...
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Account.PROPERTY_TRANSACTION, result);
   ...
   public AccountPO createTransactionLink(TransactionPO tgt)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_TRANSACTION);
   }

   public AccountPO createTransactionLink(TransactionPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_TRANSACTION, modifier);
   }
   ...
   public TransactionSet getTransaction()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Account) this.getCurrentMatch()).getTransaction();
      }
      return null;
   }

   public TransactionPO createToAccountPO()
   {
      TransactionPO result = new TransactionPO(new Transaction[]{});
      
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Account.PROPERTY_TOACCOUNT, result);
      
      return result;
   }

   public TransactionPO createToAccountPO(String modifier)
   {
      TransactionPO result = new TransactionPO(new Transaction[]{});
   ...
   public AccountPO createToAccountLink(TransactionPO tgt)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_TOACCOUNT);
   }

   public AccountPO createToAccountLink(TransactionPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_TOACCOUNT, modifier);
   }
   ...
   public TransactionSet getToAccount()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Account) this.getCurrentMatch()).getToAccount();
      }
      return null;
   }

   public TransactionPO createFromAccountPO()
   {
      TransactionPO result = new TransactionPO(new Transaction[]{});
      
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Account.PROPERTY_FROMACCOUNT, result);
      
      return result;
   }

   public TransactionPO createFromAccountPO(String modifier)
   {
      TransactionPO result = new TransactionPO(new Transaction[]{});
   ...
   public AccountPO createFromAccountLink(TransactionPO tgt)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_FROMACCOUNT);
   }

   public AccountPO createFromAccountLink(TransactionPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Account.PROPERTY_FROMACCOUNT, modifier);
   }
   ...
   public TransactionSet getFromAccount()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Account) this.getCurrentMatch()).getFromAccount();
      }
      return null;
   }
