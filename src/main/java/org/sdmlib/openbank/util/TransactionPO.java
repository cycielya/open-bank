...
public class TransactionPO extends PatternObject<TransactionPO, Transaction>
{
   ...
   public AccountPO createTransactionPO()
   {
      AccountPO result = new AccountPO(new Account[]{});
      
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Transaction.PROPERTY_TRANSACTION, result);
      
      return result;
   }

   public AccountPO createTransactionPO(String modifier)
   {
      AccountPO result = new AccountPO(new Account[]{});
   ...
   public TransactionPO createTransactionLink(AccountPO tgt)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_TRANSACTION);
   }

   public TransactionPO createTransactionLink(AccountPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_TRANSACTION, modifier);
   }
   ...
   public Account getTransaction()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Transaction) this.getCurrentMatch()).getTransaction();
      }
      return null;
   }

   public AccountPO createDebitPO()
   {
      AccountPO result = new AccountPO(new Account[]{});
      
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Transaction.PROPERTY_DEBIT, result);
      
      return result;
   }

   public AccountPO createDebitPO(String modifier)
   {
      AccountPO result = new AccountPO(new Account[]{});
   ...
   public TransactionPO createDebitLink(AccountPO tgt)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_DEBIT);
   }

   public TransactionPO createDebitLink(AccountPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_DEBIT, modifier);
   }
   ...
   public Account getDebit()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Transaction) this.getCurrentMatch()).getDebit();
      }
      return null;
   }

   public AccountPO createCreditPO()
   {
      AccountPO result = new AccountPO(new Account[]{});
      
      result.setModifier(this.getPattern().getModifier());
      super.hasLink(Transaction.PROPERTY_CREDIT, result);
      
      return result;
   }

   public AccountPO createCreditPO(String modifier)
   {
      AccountPO result = new AccountPO(new Account[]{});
   ...
   public TransactionPO createCreditLink(AccountPO tgt)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_CREDIT);
   }

   public TransactionPO createCreditLink(AccountPO tgt, String modifier)
   {
      return hasLinkConstraint(tgt, Transaction.PROPERTY_CREDIT, modifier);
   }
   ...
   public Account getCredit()
   {
      if (this.getPattern().getHasMatch())
      {
         return ((Transaction) this.getCurrentMatch()).getCredit();
      }
      return null;
   }
